...
Levy et al. \cite{levy2020} desarrollaron \textit{SafeRoute}, un sistema de aprendizaje por refuerzo para la navegación segura en entornos urbanos. Su agente aprende a navegar por las calles de una ciudad evitando zonas de alta criminalidad, utilizando datos históricos de crímenes de la ciudad de San Francisco. Una de las aportaciones más interesantes de este trabajo es la demostración de que las rutas seguras cambian significativamente entre el día y la noche, lo que pone de manifiesto la importancia de la dimensión temporal en la evaluación del riesgo.
