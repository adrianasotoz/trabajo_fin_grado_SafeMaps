...
% Figura de arquitectura — añadir cuando tengas el diagrama
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.85\textwidth]{figuras/arquitectura_sistema.png}
%   \caption{Arquitectura general del sistema SafeWalk-Madrid.}
