...
El proyecto ha sido desarrollado en su totalidad por una única persona, compaginando el trabajo con unas prácticas curriculares en empresa entre marzo y junio, y con una incorporación laboral posterior. Esta circunstancia ha condicionado directamente la forma de gestionar el proyecto: en lugar de sesiones largas de trabajo, la dedicación real ha consistido en sesiones cortas —en torno a dos horas—, dispersas de lunes a viernes, a lo largo de aproximadamente seis meses.

Dado este contexto, no se ha empleado ninguna herramienta de gestión de proyectos externa (tipo Jira o Trello): la planificación se ha resuelto de forma informal, apoyándose en la misma lógica incremental por fuente de datos descrita en la Sección~\ref{sec:metodologia_desarrollo}. Cada fase de la planificación (Sección~\ref{sec:planificacion_temporal}) se corresponde con un incremento funcional autocontenido —una fuente de datos cargada, el índice de seguridad calculado, el motor de enrutamiento funcionando, el visor web operativo—, lo que ha permitido retomar el trabajo en sesiones cortas sin necesidad de recuperar contexto extenso de una sesión a otra.

Como ya se señaló en la Sección~\ref{sec:metodologia_desarrollo}, el criterio seguido para los commits de Git ha sido uno por hito funcional. En la práctica, durante las semanas de mayor carga de las prácticas en empresa, varios hitos completados en sesiones locales se consolidaron y se subieron al repositorio juntos en cuanto hubo tiempo para revisarlos con calma; esto explica que el historial de commits del proyecto muestre una concentración de hitos en fechas puntuales (en particular, a mediados de agosto) que no refleja fielmente el reparto real del esfuerzo, más disperso en el tiempo de lo que el propio historial de Git sugiere.
...
\begin{enumerate}
    ...
    \item \textbf{F6 — Prototipo del visor web} (3 -- 21 agosto): desarrollo del backend Flask y el frontend Leaflet (Secciones~\ref{sec:backend_visor} y~\ref{sec:frontend_visor}), incluyendo el rediseño posterior con buscador Nominatim y los modos simple/detallado.
...
Al tratarse de un Trabajo Fin de Grado, el proyecto no ha generado ningún desembolso económico real. No obstante, y como es habitual en esta memoria, se incluye a continuación una estimación orientativa de su coste si se hubiera desarrollado en un contexto profesional.
