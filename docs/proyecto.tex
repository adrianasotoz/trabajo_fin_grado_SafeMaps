...
\usetikzlibrary{arrows.meta, positioning, fit, backgrounds}  % Diagrama de arquitectura (Cap. 3)
...
\newcommand{\myEmail}{asotoza@correo.ugr.es\xspace}  % <-- pon tu email real
...
\newcommand{\myTime}{Junio de 2026\xspace}  % <-- fecha fija, mejor que \today
...
% ----------------------------------------------------------------
% IMPORTANTE: \headheight debe declararse ANTES de \pagestyle{fancy}
...
\listoffigures           % Lista de figuras   (descomenta si tienes figuras)
%\listoftables           % Lista de tablas    (descomenta si tienes tablas)
...
\input{capitulos/05_GestionProyecto}
\input{capitulos/06_PruebasValidacion}
...
% ----------------------------------------------------------------
% APÉNDICES (descomenta cuando los tengas)
% ----------------------------------------------------------------
%\appendix
%\input{apendices/apendice_etl}
%\input{apendices/apendice_sql}
