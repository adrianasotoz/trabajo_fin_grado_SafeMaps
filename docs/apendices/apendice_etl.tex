...
Este apéndice recoge tres fragmentos de código Python representativos del proceso ETL descrito en la Sección~\ref{sec:etl} y en la Sección~\ref{sec:metodologia_desarrollo}, elegidos por ilustrar patrones que se repiten a lo largo de todos los scripts de \texttt{scripts/} o por resolver una decisión de diseño no trivial. El código completo de cada script sigue la misma estructura que estos fragmentos, con las fases de extracción, transformación y carga descritas en la Sección~\ref{sec:etl}, y no se reproduce aquí en su totalidad por brevedad.
